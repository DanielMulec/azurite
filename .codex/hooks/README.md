...
- `UserPromptSubmit` reads the active task title and instructs Codex to use its native title action to apply the `[Azurite] ` prefix. This keeps the running desktop sidebar synchronized without writing Codex's SQLite database directly.
